...
export const FeaturesSection = () => (
   <section id="features" className="border-y border-white/5 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 auto-rows-[minmax(300px,auto)]">
          <FadeIn delay={100} direction="left" className="lg:col-span-2 h-full flex">
          ...
          <FadeIn delay={200} direction="right" className="h-full flex">
          ...
          <FadeIn delay={300} direction="scale" className="h-full flex">
            <GlassCard className="p-8 md:p-10 flex flex-col w-full h-full">
          ...
          <FadeIn delay={400} direction="up" className="lg:col-span-3">
            <GlassCard className="flex flex-col w-full overflow-hidden">
              <div className="p-8 md:p-10 flex flex-col md:flex-row gap-6 md:items-center justify-between z-10 relative">
                ...
                <div className="w-full md:w-1/3 flex md:justify-end">
                   <button className="bg-indigo-600 hover:bg-indigo-500 text-white font-bold py-3 px-6 rounded-xl transition-colors flex items-center gap-2 shadow-md">
                    جرب المخطط الآن <Rocket size={18} />
                  </button>
                </div>
              </div>
              <div className="w-full h-[450px] md:h-[600px] relative border-t border-white/5 mt-4">
