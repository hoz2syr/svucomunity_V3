...
export const ComingSoonSection = () => {
  ...
  return (
    <section className="py-24 px-4 text-center w-full relative">
            ...
            {isSubmitted ? (
              ...
              <form className="flex gap-2" onSubmit={handleNotifySubmit}>
                <input
                  ...
                  required
                   className="flex-1 bg-[var(--color-bg-primary)] border border-slate-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-indigo-500 transition-colors text-right"
                  dir="auto"
                />
                <button
                  type="submit"
                   className="shimmer-sweep bg-gradient-to-r from-[var(--color-primary-600)] to-[var(--color-secondary-500)] text-white px-6 py-3 rounded-lg font-medium shadow-md transition-colors whitespace-nowrap"
                >
                  أبلغني عند الإطلاق
                </button>
              </form>
