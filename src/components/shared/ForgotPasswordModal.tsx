          ...
          >
            ...
            <form onSubmit={handleReset} className="space-y-5">
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-cyan-500 to-indigo-600 text-white font-bold py-3.5 px-4 rounded-xl shadow-[0_0_20px_rgba(34,211,238,0.3)] hover:shadow-[0_0_30px_rgba(34,211,238,0.5)] transition-all disabled:opacity-70 disabled:cursor-not-allowed"
              >
