...
export class ErrorBoundary extends Component<Props, BoundaryState> {
  ...
  public render() {
    if (this.state.hasError) {
      return (
        <div className="flex flex-col items-center justify-center p-8 bg-[var(--color-bg-primary)]/80 backdrop-blur-md rounded-2xl border border-[var(--color-danger-border)] text-center m-4">
