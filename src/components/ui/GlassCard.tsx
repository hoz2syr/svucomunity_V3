...
export const GlassCard = ({ children, className = "" }: { children: React.ReactNode; className?: string }) => (
  <div className={`bg-[var(--color-bg-card)] backdrop-blur-xl border border-white/5 rounded-3xl shadow-[var(--shadow-card)] overflow-hidden relative group transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_20px_40px_-15px_rgba(34,211,238,0.15)] hover:border-white/10 ${className}`}>
