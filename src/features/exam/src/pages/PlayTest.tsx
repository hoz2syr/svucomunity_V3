...
export default function PlayTest() {
  ...
  if (!hasStarted) {
    return (
      <div className="max-w-3xl mx-auto space-y-4 sm:space-y-6 animation-fade-in-up px-3 sm:px-0 pb-24">
        <button onClick={() => navigate('/exam/saved')} className="flex items-center gap-2 px-3 py-2.5 rounded-xl bg-white/5 border border-white/10 text-slate-400 hover:text-white hover:border-white/20 transition min-h-[44px]">
        ...
        <div className="glass-card p-4 sm:p-6 md:p-8 text-center space-y-4 sm:space-y-6">
          <div className="w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 mx-auto rounded-full bg-cyan-500/10 flex items-center justify-center mb-2 border border-cyan-500/20">
            <FileText className="w-7 h-7 sm:w-8 sm:h-8 md:w-10 md:h-10 text-cyan-400" />
          </div>
    ...
    return (
      <div className="max-w-3xl mx-auto space-y-4 sm:space-y-6 pb-24">
        ...
        <div className="glass-card text-center p-5 sm:p-8 md:p-12">
          ...
          <p className="text-[10px] sm:text-xs text-secondary-400">تقييم الاختبار</p>
        </div>
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-4 sm:space-y-6 pb-24">
      <button onClick={() => navigate('/exam/saved')} className="text-secondary-400 hover:text-white flex items-center gap-2 mb-4 sm:mb-6 transition min-h-[44px]">
        <ArrowLeft className="w-4 h-4 sm:w-5 sm:h-5" />
      ...
      <div className="glass-card" onKeyDown={handleKeyDown} tabIndex={0}>
        ...
        {isAnswerRevealed && (
          <div className={cn('mt-3 sm:mt-4 md:mt-6 p-3 sm:p-4 rounded-xl border', isCurrentCorrect ? 'bg-green-500/10 border-green-500/30' : 'bg-red-500/10 border-red-500/30')}>
            <div className="flex items-start gap-2.5 sm:gap-3">
              {isCurrentCorrect ? <CheckCircle2 className="w-4 h-4 sm:w-5 sm:h-5 text-green-400 mt-0.5 flex-shrink-0" /> : <XCircle className="w-4 h-4 sm:w-5 sm:h-5 text-red-400 mt-0.5 flex-shrink-0" />}
              <div>
