...
function PublishedTestCard({ test }: { test: TestModel }) {
  return (
    <div
      className="bg-slate-900/60 border border-white/8 flex flex-col h-full rounded-2xl overflow-hidden transition-all duration-150 hover:shadow-md hover:border-white/14"
    >
