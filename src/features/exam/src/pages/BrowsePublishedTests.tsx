  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6 animation-fade-in-up mt-6">
      ...
      {error ? (
        ...
        <div className="bg-slate-950 border border-white/8 flex flex-col items-center justify-center p-12 text-center">
...
function PublishedTestCard({ test }: { test: TestModel }) {
  return (
    <div
      className="bg-stone-900/60 border border-amber-700/30 flex flex-col h-full rounded-2xl overflow-hidden transition-all duration-150 hover:shadow-[6px_6px_0px_0px_rgba(180,130,50,0.3)] hover:border-amber-600/50"
    >
