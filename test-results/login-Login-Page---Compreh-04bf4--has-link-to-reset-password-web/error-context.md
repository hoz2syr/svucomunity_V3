...
- Name: login.spec.ts >> Login Page - Comprehensive >> login page has link to reset password
- Location: apps\web\tests\e2e\login.spec.ts:39:3
...
Locator: getByRole('link', { name: /إعادة تعيين|reset|forgot|نسيت كلمة المرور/i }).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('link', { name: /إعادة تعيين|reset|forgot|نسيت كلمة المرور/i }).first()
