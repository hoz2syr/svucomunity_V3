...
- Name: login.spec.ts >> Login Page - Comprehensive >> login form has submit button
- Location: apps\web\tests\e2e\login.spec.ts:25:3
...
Locator: getByRole('button', { name: /login|تسجيل الدخول|دخول/i }).first()
Expected: visible
Timeout: 5000ms
